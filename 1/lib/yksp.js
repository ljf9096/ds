var rule = {
    ...
    timeout: 5000,
    class_name: '优酷电视剧&优酷电影&优酷综艺&优酷动漫&优酷少儿&优酷纪录片&优酷文化&优酷亲子&优酷教育&优酷搞笑&优酷生活&优酷体育&优酷音乐&优酷游戏',
    class_url: '电视剧&电影&综艺&动漫&少儿&纪录片&文化&亲子&教育&搞笑&生活&体育&音乐&游戏',
    limit: 20,
    play_parse: true,
lazy:'js:input="https://coffee.1ljx.com:32000/api/?key=36d3e7f8-f971-44a7-9063-5db4f218491d&url="+input.split("?")[0];log(input);let html=JSON.parse(request(input));log(html);input=html.url||input',
    一级: $js.toString(() => {
        let d = [];
        MY_FL.type = MY_CATE;
